...
namespace ServiceMtk_P1_20190140060
{
    ...
    public class Koordinat
    {
        ...
        // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceMtk_P1_20190140060.ContractType".
        [DataContract]
